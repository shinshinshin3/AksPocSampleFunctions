...
namespace consumerFunction01.common
{
    public class Logger
    {
        ...
        private readonly bool consoleOut = true;
        ...
        {
            string log = string.Format(LOG_FORMAT, DateTime.UtcNow.ToString(DATETIME_FORMAT), level.ToString(), text);
